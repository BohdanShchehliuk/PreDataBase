...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // зміна даних (працює):
        Read read2 = new Read("C:\\Users\\User\\Desktop\\PreDataBase\\src\\Data_from_servis\\ShchehliukBohdanRenewal.txt");

        // зміна паролю. працює
        Read read3 = new Read("C:\\Users\\User\\Desktop\\PreDataBase\\src\\Data_from_servis\\ShehliukBohdanPasword.txt");
